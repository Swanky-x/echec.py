...
<body>
    ...
    <div>
        ...
        <form action="result.py" method="post">   
            <p><input type="text" name="pseudo" pattern="^[a-zA-Z0-9_]{3,20}$" placeholder="Votre pseudo" />
            <input type="password" name="password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9]).{6,}$" placeholder="Votre mot de passe" />
            <input type="submit" name="send" value="Sign In"></p>
        </form>
    </div>
    ...
    <div>
        ...
        <form action="result.py" method="post">   
            <p><input type="text" name="c_pseudo" pattern="^[a-zA-Z0-9_]{3,20}$" placeholder="Choisir un pseudo" />
            ...
            <input type="submit" name="send2" value="Sign Up"></p>
        </form>
    </div>  
